...
public class QuadtreeCorrectTest {
     ...
     * printBinaryPower(100.0); printBinaryPower(0.234); printBinaryPower(0.000003455); }
     * 
     * public static void printBinaryPower(double num) { BinaryPower pow2 = new BinaryPower(); int
     * exp = BinaryPower.exponent(num); double p2 = pow2.power(exp); System.out.println(num +
     * " : pow2 = " + Math.pow(2.0, exp) + "   exp = " + exp + "   2^exp = " + p2); }
     */
